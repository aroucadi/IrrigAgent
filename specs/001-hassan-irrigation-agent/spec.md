...
- **M6 (Infrastructure Roadmap)**: Migrate Cloud Infrastructure to declarative Terraform IaC (`infra/` module) and automated GitHub Actions CI/CD deployment pipeline post-pilot selection.
