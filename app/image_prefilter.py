...
FEEDBACK_MESSAGES: Dict[QualityDefectReason, str] = {
    ...
    QualityDefectReason.RESOLUTION_TOO_LOW: (
        "🍃 *Resolution Too Low*\n"
        "The photo is too small for leaf disease analysis. Please send a higher resolution photograph."
    ),
    QualityDefectReason.BLURRY: (
        "🍃 *Photo Out of Focus*\n"
        "The leaf photo is blurry. Please hold your camera steady and retake a sharp, in-focus photograph."
    ),
...
def validate_image_quality(
    ...
    # Check minimum resolution bounds
